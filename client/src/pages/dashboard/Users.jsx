...
const usersData = [
  {
    ...
    profileImage: "https://images.unsplash.com/photo-1608174386344-80898cec6beb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80",
    status: "Active",
  ...
  },
  {
    ...
    profileImage: "https://images.unsplash.com/photo-1488508872907-592763824245?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
    status: "Active",
    role: "Lead Designer",
  ...
  },
  {
    ...
    profileImage: "https://images.unsplash.com/photo-1499470932971-a90681ce8530?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
    status: "Active",
    role: "Marketing Specialist",
    email: "sophia@example.com",
    teams: ["Marketing", "SEO", "Social Media"]
  },
  {
    id: 4,
    name: {
  ...
  },
  {
    id: 5,
    name: {
      full: "Amelia Anderson",
      username: "@ameliaanderson"
    },
    profileImage: "https://images.unsplash.com/photo-1531590878845-12627191e687?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80",
    status: "Active",
    role: "Lead Developer",
...
export default function Users() {
  const darkMode = true
  return (
    <section className="bg-gray-900 h-screen px-4 mx-auto">
      <div className="flex items-center gap-x-3">
        <h2 className={`text-lg font-medium ${darkMode?'text-gray-800':"text-white"}`}>Team members</h2>
        <span className={`px-3 py-1 text-xs- ${darkMode?'text-blue-600 bg-gray-800':'bg-blue-100 text-blue-400'}   rounded-full`}>
                      ...
                      <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                        <div className="inline-flex items-center gap-x-3">
                          ...
                          <div className="flex items-center gap-x-2">
                            ...
                            />
                            <div>
                              <h2 className="font-medium text-gray-800 dark:text-white">{user.name.full}</h2>
                              <p className="text-sm font-normal text-gray-600 dark:text-gray-400">{user.name.username}</p>
                            </div>
                          </div>
                        </div>
                      </td>
                        ...
                        <div className="flex items-center gap-x-2">
                          {user.teams.map((team) => (
                            <p 
                              key={team} 
                              className={`
                                px-3 py-1 text-xs rounded-full dark:bg-gray-800 
